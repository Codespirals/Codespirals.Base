namespace Codespirals.Base
{
    ...
    public interface ICRUDable<TReturn, TCreate, TEdit, TDeleteReturn, TId> : ICreatable<TCreate, TReturn>, IRetrievable<TReturn, TId>, IUpdatable<TEdit, TReturn>, IDeletable<TDeleteReturn, TId>
    {

    }
    /// <inheritdoc/>
    public interface ICRUDableAsync<TReturn, TCreate, TEdit, TDeleteReturn, TId> : ICreatableAsync<TCreate, TReturn>, IRetrievableAsync<TReturn, TId>, IUpdatableAsync<TEdit, TReturn>, IDeletableAsync<TDeleteReturn, TId>
    {
